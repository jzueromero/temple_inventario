...
--
-- Servidor: localhost
-- Tiempo de generación: 17-08-2021 a las 13:42:53
...
(193, '124', 'AGUA DESTILANDA VHJ X 10 CC. RM ND	', '', '-3.00', '', '0.00', '0.00', '0.00', '1.44', 0, 0, '2021-04-04 06:59:38', -15, 10, 0, 0, 0),
...
CREATE TABLE `talo_talonario` (
  ...
  `talo_serie` varchar(50) COLLATE utf8mb4_general_ci DEFAULT '',
...
(1, 'Josue', 'Romero', 'admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 1, 0, 1, '2021-08-05 17:01:29'),
(2, 'jefe ', 'jefe', 'jefe', 'a7434f460c6827fd280bc540f309c25003a50ef4', 1, 1, 0, '2021-07-03 10:04:05'),
(4, 'caja1', 'caja1', 'caja1', 'b2620e7780274ca3bf47d573523c226e4963c6ef', 1, 1, 1, '2021-08-05 17:04:23'),
...
CREATE TABLE `ventd_detalle` (
  ...
  `ventd_tran_codigo` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `vent_venta` (`vent_codigo`, `vent_codigo_temporal`, `vent_serie`, `vent_correlativo`, `vent_comanda`, `vent_sucursal_codigo`, `vent_estado`, `vent_referencia`, `vent_comentario`, `vent_usuario`, `vent_fecha`, `vent_total`, `vent_fecha_anula`, `vent_usuario_anula`) VALUES
(1, 'temporal', 'a', 0, 0, 1, 'COMANDA', 0, '', 1, '2021-08-06 00:00:00', '0.0000', NULL, 0);
...
--
ALTER TABLE `hist_historial`
  MODIFY `hist_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=173;

--
-- AUTO_INCREMENT de la tabla `kardex`
--
ALTER TABLE `kardex`
  MODIFY `kard_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=290;
...
--
ALTER TABLE `sucu_usuario`
  MODIFY `sucu_usua_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `trad_detalle`
  MODIFY `trad_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT de la tabla `tran_transaccion`
--
ALTER TABLE `tran_transaccion`
  MODIFY `tran_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `ventd_detalle`
  MODIFY `ventd_codigo` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `vent_venta`
--
ALTER TABLE `vent_venta`
  MODIFY `vent_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
COMMIT;
