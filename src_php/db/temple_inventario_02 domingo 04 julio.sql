...
--
-- Servidor: localhost
-- Tiempo de generación: 05-07-2021 a las 02:07:17
...
--
-- Base de datos: `temple_inventario_02`
--
...
CREATE TABLE `conc_concepto` (
  ...
  `conc_nombre` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `trad_detalle` (
  ...
  `trand_tran_codigo` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `trand_prod_codigo` int(11) DEFAULT '0',
  `tran_precio_codigo` int(11) DEFAULT '0',
  `tran_precio` decimal(10,4) DEFAULT '0.0000',
  `tran_cantidad` int(11) DEFAULT '0',
  `tran_total` decimal(10,4) DEFAULT '0.0000'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tran_transaccion` (
  ...
  `tran_sucursal_codigo` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tran_transaccion` (`tran_codigo`, `tran_codigo_temporal`, `tran_tipo`, `tran_estado`, `tran_codigo_concepto`, `tran_nombre_concepto`, `tran_codigo_cliente`, `tran_nombre_cliente`, `tran_codigo_proveedor`, `tran_nombre_proveedor`, `tran_actualizar_costo`, `tran_referencia`, `tran_cantidad_articulo`, `tran_recibido`, `tran_cambio`, `tran_total`, `tran_usuario_inicia`, `tran_fecha`, `tran_usuario_fin`, `tran_fecha_fin`, `tran_sucursal_codigo`) VALUES
(1, '  ', 1, 0, 0, '', 0, '', 0, '', 0, '', 0, '0.00', '0.00', '0.00', 0, '2021-04-06 14:57:59', 0, NULL, NULL);
...
CREATE TABLE `venc_vencimiento` (
  ...
  `venc_lote` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `venc_producto_codigo` int(11) DEFAULT '0',
  `venc_cantidad` int(11) DEFAULT '0',
  `venc_cantidad_restante` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `venc_fecha` datetime DEFAULT CURRENT_TIMESTAMP,
  `venc_fecha_vencimiento` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(1, 'L-2021-01', 97, 10, '10', '2021-07-04 18:26:09', '2021-07-10', 1),
(2, 'L-2021-02', 97, 15, '15', '2021-07-04 18:26:54', '2021-05-30', 2),
(3, 'L-2021-03', 97, 20, '20', '2021-07-04 18:27:39', '2021-12-12', 1);
...
--
ALTER TABLE `hist_historial`
  MODIFY `hist_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;
...
--
ALTER TABLE `trad_detalle`
  MODIFY `trad_codigo` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `venc_vencimiento`
  MODIFY `venc_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
