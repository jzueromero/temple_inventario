<?php
	...
	$formulario_acceso="usu";


$modelo = 'usuario';
$nombre_form = "sis_usuario";
$titulo_form = "Conf. Modulo Usuarios";
$descripcion_form = 'Lista de todos los usuarios registrados en el sistema';
...
$consulta = "select usua_codigo  codigo, concat_ws(' ', usua_nombre, usua_apellido) as nombre,
				 ...
				 from usua_usuario order by usua_nombre";
$parametros = array(""=>'');
