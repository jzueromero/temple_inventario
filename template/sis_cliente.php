...
$modelo = 'cliente';
$nombre_form = "sis_cliente";
$titulo_form = "Modulo Clientes";
$descripcion_form = 'Configuracion de clientes y destinos de producto.';
$nombre_negocio = $objeto_datos->empresa;


$consulta = "SELECT clie_codigo codigo, clie_nombre nombre, clie_direccion direccion, clie_pais pais,
            clie_responsable responsable, clie_contacto contacto, clie_fecha fecha
            FROM clie_cliente order by clie_nombre, clie_responsable, clie_pais ;";
