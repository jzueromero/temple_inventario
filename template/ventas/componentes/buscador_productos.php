...
foreach ($arreglo_buscador as $pr) {
    ...
    ?>
              <tr>
                <td>
                    <button class="btn btn-primary" data-toggle="modal" data-target="#modalExistencias" onclick="VerificaExistencia('<?php echo $pr['prod_codigo']; ?>')">
                      ::
        ...
        ?>
                        ...
                        data-equi="<?php echo $equi['codigo']; ?>"
                         data-precio="<?php echo $equi['precio']; ?>"
                          ...
                          <?php echo $equi['unidad']." <b>$ ". number_format((float)$equi['precio'],2,'.','')."</b>"; ?>
                        </option>
                    <?php
}
    ?>
