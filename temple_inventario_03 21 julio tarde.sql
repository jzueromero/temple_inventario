...
--
-- Servidor: localhost
-- Tiempo de generación: 22-07-2021 a las 01:21:37
...
(97, '741000281', 'ACETAMINOFEN MK 500 MG X 100 TABLETAS	', '', '0.00', 'tabletas', '0.80', '0.20', '1.00', '5.40', 0, 0, '2021-07-04 18:37:37', 1111111111, -48, 3, 4444444, 5),
...
--
ALTER TABLE `kardex`
  MODIFY `kard_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=194;
...
--
ALTER TABLE `trad_detalle`
  MODIFY `trad_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT de la tabla `tran_transaccion`
--
ALTER TABLE `tran_transaccion`
  MODIFY `tran_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
